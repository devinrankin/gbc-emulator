...
static unsigned sm83_op_noimpl(sm83_t* sm83, uint8_t opcode);
...
static unsigned sm83_op_ld_r16_imm16(sm83_t* sm83, uint8_t opcode) {
    ...
    uint8_t val = bus_read16(sm83->bus, sm83->registers.pc);
...
static unsigned sm83_op_ld_r16mem_a(sm83_t* sm83, uint8_t opcode) {
    ...
    bus_write8(sm83->bus, addr, sm83_read_r8_or_hl(sm83, SM83_REGISTER_IDX_A));
...
static unsigned sm83_op_ld_r8_imm8(sm83_t* sm83, uint8_t opcode) {
    ...
    uint8_t val = bus_read8(sm83->bus, sm83->registers.pc + 1);
...
static unsigned sm83_op_ld_a_r16mem(sm83_t* sm83, uint8_t opcode) {
    ...
    sm83_write_r8_or_hl(sm83, SM83_REGISTER_IDX_A, bus_read8(sm83->bus, addr));
